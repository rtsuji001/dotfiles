...
#    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
    PS1='${debian_chroot:+($debian_chroot)}\[\e[1;33m\]\u\[\e[1;30m\]@\[\e[1;35m\]\h\[\e[1;30m\]:\[\e[1;36m\]\w \[\e[1;30m\]\$\[\e[0;32m\] '
else
...
function html2pdf() {
  command xvfb-run -- /usr/bin/wkhtmltopdf $1.html $1.pdf
}

function md2html() {
  command pandoc -f markdown -t html5 -c ~/.pandoc/github.css --self-contained $1.md -o $1.html
}
...
export PATH=/usr/local/texlive/2018/bin/armhf-linux:$HOME/bin:$PATH
